...
class INTERIMData:
    '''
    ERA INTERIM data extraction (from old server)
    '''
    def __init__(self,basefolder):
        ...
        See also the module interim for data extraction from the new
        ERA INTERIM server (some vars have different name and structure
        (new dim type)
        '''
...
def interim_file_data(files,quiet=False):
    ...
    To be used with data obtained from the old server:
    http://data-portal.ecmwf.int/data/d/interim_daily/

    http://apps.ecmwf.int/datasets/

    To deal with new server,  http://apps.ecmwf.int/datasets/) use
    the module interim
